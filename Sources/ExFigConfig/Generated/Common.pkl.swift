...
public protocol Common_FrameSource: Common_NameProcessing {
    ...
    var rtlActiveValues: [String]? { get }

    var variablesDarkMode: Common.VariablesDarkMode? { get }
}
...
extension Common {
    ...
    /// Dark mode via Figma Variable bindings (per-entry).
    /// Resolves variable values in dark mode and replaces colors in exported SVGs.
    public struct VariablesDarkMode: PklRegisteredType, Decodable, Hashable, Sendable {
        public static let registeredIdentifier: String = "Common#VariablesDarkMode"

        /// Variable collection name (e.g., "DesignTokens").
        public var collectionName: String

        /// Light mode name in the collection (e.g., "Light").
        public var lightModeName: String

        /// Dark mode name in the collection (e.g., "Dark").
        public var darkModeName: String
    ...
    /// Dark mode via name suffix splitting (global, on common.icons/images/colors).
    /// Icons/images with the suffix are treated as dark variants.
    public struct SuffixDarkMode: PklRegisteredType, Decodable, Hashable, Sendable {
        public static let registeredIdentifier: String = "Common#SuffixDarkMode"

        /// Dark mode name suffix (e.g., "_dark").
    ...
    public struct FrameSourceImpl: FrameSource {
        ...
        /// Components with these values are skipped during export — the base variant
        /// is mirrored at runtime by the platform.
        /// Default: `new { "On" }`. Set to `new { "On"; "true" }` if your Figma file
        /// uses both naming conventions.
        public var rtlActiveValues: [String]?

        /// Dark mode generation via Figma Variable bindings.
        /// When set, dark SVG variants are generated by resolving variable bindings
        /// and replacing colors in the light SVG.
        public var variablesDarkMode: VariablesDarkMode?
        ...
        public init(
            ...
            self.variablesDarkMode = variablesDarkMode
            self.nameValidateRegexp = nameValidateRegexp
            self.nameReplaceRegexp = nameReplaceRegexp
        }
    }
    ...
    public struct Colors: NameProcessing {
        ...
        /// Dark mode via name suffix splitting.
        public var suffixDarkMode: SuffixDarkMode?
        ...
        public init(
            suffixDarkMode: SuffixDarkMode?,
            lightHCModeSuffix: String?,
            darkHCModeSuffix: String?,
            nameValidateRegexp: String?,
            nameReplaceRegexp: String?
        ) {
            self.suffixDarkMode = suffixDarkMode
