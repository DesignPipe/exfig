...
ios = new iOS.iOSConfig {
  ...
  // [optional] When `xcassetsInSwiftPackage: true` use this property to specify a resource bundle name for Swift packages
  // containing Assets.xcassets (e.g. ["PackageName_TargetName"]). This is necessary to avoid SwiftUI Preview crashes.
  ...
  colors = new iOS.ColorsEntry {
    ...
    // [optional] If true and a color style name contains symbol "/" then "/" symbol indicates grouping by folders,
    // and each folder will have the "Provides Namespace" property enabled. Defaults to false.
  ...
  icons = new iOS.IconsEntry {
    ...
    nameStyle = "camelCase"
    // [optional] An array of icon names that will support Preserve Vector Data. Use "*" to enable for all icons.
    ...
    // [optional] Asset render mode: "template", "original" or "default". Default value is "template".
    // renderMode = "default"
    // [optional] Suffix for filtering icons to use "default" render mode. Works when renderMode is "template".
    // renderModeDefaultSuffix = "_default"
    // [optional] Suffix for filtering icons to use "original" render mode. Works when renderMode is "template".
    // renderModeOriginalSuffix = "_original"
    // [optional] Suffix for filtering icons to use "template" render mode. Works when renderMode is not "template".
